...
`;l(document.querySelector("#counter"));document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("toggle-theme"),t=document.documentElement;localStorage.getItem("theme")==="dark"&&t.classList.add("dark"),e==null||e.addEventListener("click",()=>{t.classList.toggle("dark"),localStorage.setItem("theme",t.classList.contains("dark")?"dark":"light")})});
